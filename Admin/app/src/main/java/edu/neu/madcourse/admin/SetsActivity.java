package edu.neu.madcourse.admin;
...
import edu.neu.madcourse.admin.R;
...
public class SetsActivity extends AppCompatActivity {
    ...
    private void loadSets()
    {
        ...
        firestore.collection("QUIZ").document(CategoryActivity.catList.get(CategoryActivity.selected_cat_index).getId())
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                CategoryActivity.catList.get(CategoryActivity.selected_cat_index).setSetCounter(documentSnapshot.getString("COUNTER"));
                CategoryActivity.catList.get(CategoryActivity.selected_cat_index).setNoOfSets(String.valueOf(noOfSets));
    ...
    private void addNewSet()
    {
        ...
        final String curr_cat_id = CategoryActivity.catList.get(CategoryActivity.selected_cat_index).getId();
        final String curr_counter = CategoryActivity.catList.get(CategoryActivity.selected_cat_index).getSetCounter();
                        ...
                        firestore.collection("QUIZ").document(curr_cat_id)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        CategoryActivity.catList.get(CategoryActivity.selected_cat_index).setNoOfSets(String.valueOf(setsIDs.size()));
                                        CategoryActivity.catList.get(CategoryActivity.selected_cat_index).setSetCounter(String.valueOf(Integer.valueOf(curr_counter) + 1));
